...
abstract class AuthModule {
	@Binds
	@Singleton
	abstract fun bindSessionDataStore(sessionDataStore: PreferencesSessionDataStore): SessionDataStore

	@Binds
	@Singleton
	abstract fun bindAuthRepository(authRepository: LocalAuthRepository): AuthRepository
