...
private const val LightPreviewBackground = 0xFFF8FAFC
private const val DarkPreviewBackground = 0xFF0F172A
...
private fun PreviewTheme(
    ...
    RxCatalogTheme(darkTheme = isSystemInDarkTheme(), dynamicColor = false) {
        Surface(
