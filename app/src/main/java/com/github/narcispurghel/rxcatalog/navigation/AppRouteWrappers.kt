...
import com.github.narcispurghel.rxcatalog.auth.*
...
private fun SplashRoute(
	...
	SplashScreen(sessionState = sessionState, onNavigate = { route ->
...
private fun EnsureUnauthenticated(
	...
	val navigateHome =
		rememberUpdatedState(newValue = { navController.navigateSingleTop(AppRoutes.HOME) })
...
private fun EnsureAuthenticated(
	...
	val navigateLogin =
		rememberUpdatedState(newValue = { navController.navigateSingleTop(AppRoutes.LOGIN) })
